...
| [`INTERVAL_BINNED_V1_CONTRACT.md`](INTERVAL_BINNED_V1_CONTRACT.md) | P1 입력 표현·역매핑·예산 선택 계약 (`src/ua_sahi_mal/kisa_xai/`) |
| [`audit/`](audit/) | P0 데이터 접근 감사(2026-09-14, NO-GO 대기)와 환경 회귀검사 기록 |
